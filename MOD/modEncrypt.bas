...
Public Function DeCode(vText As String) As String
    ...
    Exit Function
ErrHandler:
    WriteErrorLogs Err.Number, Err.Description, "ModEncrypt {Function: Decode}", True, True
        DeCode = "Error!"
    Err.Clear
End Function
...
Public Function Encode(vText As String)
    ...
    Exit Function
ErrHandler:
        WriteErrorLogs Err.Number, Err.Description, "ModEncrypt {Function: Encode}", True, True
    Err.Clear
End Function
...
Public Function Encrypt(StringToEncrypt As String, Optional AlphaEncoding As Boolean = False) As String
    ...
    Exit Function
ErrorHandler:
    WriteErrorLogs Err.Number, Err.Description, "ModEncrypt {Function: Encrypt}", True, True
        Encrypt = "Error!"
    Err.Clear
End Function
...
Public Function Decrypt(StringToDecrypt As String, Optional AlphaDecoding As Boolean = False) As String
    ...
    Exit Function
ErrorHandler:
    WriteErrorLogs Err.Number, Err.Description, "ModEncrypt {Function: Decrypt}", True, True
        Decrypt = "Error!"
    Err.Clear
End Function
